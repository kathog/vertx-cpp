 ...
 */
public class HazelcastClusterNodeInfo extends ClusterNodeInfo implements IdentifiedDataSerializable, DataSerializableFactory {
  ...
  public IdentifiedDataSerializable create(int typeId) {
    return new HazelcastClusterNodeInfo();
  }
}
