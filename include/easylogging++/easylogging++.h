...
typedef std::unique_ptr<easyloggingpp::base::PerformanceTracker> PerformanceTrackerPtr;
}  // namespace type
...
namespace std {
template<> struct hash<easyloggingpp::Level> {
 public:
  std::size_t operator()(const easyloggingpp::Level& l) const {
    return hash<easyloggingpp::base::type::EnumType> {}(static_cast<easyloggingpp::base::type::EnumType>(l));
  }
};
}
namespace easyloggingpp {
/// @brief Static class that contains helper functions for easyloggingpp::Level
...
enum class ConfigurationType : base::type::EnumType {
  ...
  /// You may disable all logs by using easyloggingpp::Level::Global
  Enabled = 1,
...
/// @brief Static class that contains helper functions for easyloggingpp::ConfigurationType
...
/// @brief Contains utilities for cross-platform date/time. This class make use of easyloggingpp::base::utils::Str
class DateTime : base::StaticClass {
 public:
  ...
  static std::string timevalToString(struct timeval tval, const char* format,
                                     const easyloggingpp::base::SubsecondPrecision* ssPrec);
...
/// @brief Command line arguments for application if specified using easyloggingpp::Helpers::setArgs(..) or START_EASYLOGGINGPP(..)
...
class Loggable {
 public:
  ...
  virtual void log(easyloggingpp::base::type::ostream_t&) const = 0;
 private:
  friend inline easyloggingpp::base::type::ostream_t& operator<<(easyloggingpp::base::type::ostream_t& os, const Loggable& loggable) {
    loggable.log(os);
    return os;
  }
};
...
class LogFormat : public Loggable {
 public:
  ...
  virtual void log(easyloggingpp::base::type::ostream_t& os) const {
    os << m_format;
  }
 ...
 private:
  ...
  friend class easyloggingpp::Logger;  // To resolve loggerId format specifier easily
};
}  // namespace base
...
/// @see easyloggingpp::Helpers::installCustomFormatSpecifier
...
///   * easyloggingpp::Configuration confEnabledInfo(easyloggingpp::Level::Info, easyloggingpp::ConfigurationType::Enabled, "true");
///   * easyloggingpp::Configuration confMaxLogFileSizeInfo(easyloggingpp::Level::Info, easyloggingpp::ConfigurationType::MaxLogFileSize, "2048");
///   * easyloggingpp::Configuration confFilenameInfo(easyloggingpp::Level::Info, easyloggingpp::ConfigurationType::Filename, "/var/log/my.log");
...
class Configurations : public base::utils::RegistryWithPred<Configuration, Configuration::Predicate> {
 public:
  ...
  /// @param level Level to set configuration for (easyloggingpp::Level).
  /// @param configurationType Type of configuration (easyloggingpp::ConfigurationType)
  ...
  /// @see easyloggingpp::Level
  /// @see easyloggingpp::ConfigurationType
...
///
/// @detail easyloggingpp::Configurations have string based values. This is whats used internally in order to read correct configurations.
...
class TypedConfigurations : public base::threading::ThreadSafe {
 public:
  /// @brief Constructor to initialize (construct) the object off easyloggingpp::Configurations
 ...
 private:
  ...
  friend class easyloggingpp::Helpers;
  friend class easyloggingpp::base::MessageBuilder;
  friend class easyloggingpp::base::Writer;
  friend class easyloggingpp::base::DefaultLogDispatchCallback;
  friend class easyloggingpp::base::LogDispatcher;
...
class Logger : public base::threading::ThreadSafe, public Loggable {
 public:
  ...
  virtual inline void log(easyloggingpp::base::type::ostream_t& os) const {
    os << m_id.c_str();
  }
...
#  undef LOGGER_LEVEL_WRITERS_SIGNATURES
 ...
 private:
  ...
  friend class easyloggingpp::LogMessage;
  friend class easyloggingpp::Loggers;
  friend class easyloggingpp::Helpers;
  friend class easyloggingpp::base::RegisteredLoggers;
  friend class easyloggingpp::base::DefaultLogDispatchCallback;
  friend class easyloggingpp::base::MessageBuilder;
  friend class easyloggingpp::base::Writer;
  friend class easyloggingpp::base::PErrorWriter;
  friend class easyloggingpp::base::Storage;
  friend class easyloggingpp::base::PerformanceTracker;
  friend class easyloggingpp::base::LogDispatcher;
...
class Storage : base::NoCopy, public base::threading::ThreadSafe {
 ...
 private:
  ...
  friend class easyloggingpp::Helpers;
  friend class easyloggingpp::base::DefaultLogDispatchCallback;
  friend class easyloggingpp::LogBuilder;
  friend class easyloggingpp::base::MessageBuilder;
  friend class easyloggingpp::base::Writer;
  friend class easyloggingpp::base::PerformanceTracker;
  friend class easyloggingpp::base::LogDispatcher;
...
#define ELPP easyloggingpp::base::elStorage
...
easyloggingpp::base::type::ostream_t& operator<<(easyloggingpp::base::type::ostream_t& ss, const ContainerType& container) {\
const easyloggingpp::base::type::char_t* sep = ELPP->hasFlag(easyloggingpp::LoggingFlag::NewLineForContainer) ? \
ELPP_LITERAL("\n    ") : ELPP_LITERAL(", ");\
...
ss << ELPP_LITERAL("[");\
for (std::size_t i = 0; elem != endElem && i < easyloggingpp::base::consts::kMaxLogPerContainer; ++i, ++elem) { \
ss << ElementInstance;\
...
inline void Logger::verbose(int vlevel, const char* s, const T& value, const Args&... args) {
  acquireLock(); // released in Writer!
  log_(easyloggingpp::Level::Verbose, vlevel, s, value, args...);
}
template <typename T>
inline void Logger::verbose(int vlevel, const T& log) {
  acquireLock(); // released in Writer!
  log_(easyloggingpp::Level::Verbose, vlevel, log);
}
#  else
template <typename T, typename... Args>
...
class PerformanceTracker : public base::threading::ThreadSafe, public Loggable {
 public:
  PerformanceTracker(const std::string& blockName,
                     ...
                     const std::string& loggerId = std::string(easyloggingpp::base::consts::kPerformanceLoggerId),
 ...
 private:
  ...
  friend class easyloggingpp::PerformanceTrackingData;
...
class DefaultPerformanceTrackingCallback : public PerformanceTrackingCallback {
 protected:
  void handle(const PerformanceTrackingData* data) {
    ...
    easyloggingpp::base::Writer(m_data->performanceTracker()->level(), m_data->file(), m_data->line(), m_data->func()).construct(1,
...
easyloggingpp::base::type::ostream_t& operator<<(easyloggingpp::base::type::ostream_t& OutputStreamInstance, const ClassType& ClassInstance)
...
#define ELPP_INITIALIZE_SYSLOG(id, opt, fac) easyloggingpp::SysLogInitializer elSyslogInit(id, opt, fac)
...
class Helpers : base::StaticClass {
 public:
  ...
  static inline void setCrashHandler(const easyloggingpp::base::debug::CrashHandler::Handler& crashHandler) {
    easyloggingpp::elCrashHandler.setHandler(crashHandler);
  }
  ...
  static std::string convertTemplateToStdString(const T& templ) {
    easyloggingpp::Logger* logger =
      ELPP->registeredLoggers()->get(easyloggingpp::base::consts::kDefaultLoggerId);
    if (logger == nullptr) {
      return std::string();
    }
    base::MessageBuilder b;
  ...
  static inline const easyloggingpp::base::utils::CommandLineArgs* commandLineArgs(void) {
...
class Loggers : base::StaticClass {
 public:
  ...
  static void setDefaultLogBuilder(easyloggingpp::LogBuilderPtr& logBuilderPtr);
...
#  define ELPP_MIN_UNIT easyloggingpp::base::TimestampUnit::Microsecond
#else
#  define ELPP_MIN_UNIT easyloggingpp::base::TimestampUnit::Millisecond
...
/// @see easyloggingpp::base::PerformanceTracker
/// @see easyloggingpp::base::PerformanceTracker::checkpoint
// Note: Do not surround this definition with null macro because of obj instance
#define TIMED_SCOPE_IF(obj, blockname, condition) easyloggingpp::base::type::PerformanceTrackerPtr obj( condition ? \
  new easyloggingpp::base::PerformanceTracker(blockname, ELPP_MIN_UNIT) : nullptr )
#define TIMED_SCOPE(obj, blockname) TIMED_SCOPE_IF(obj, blockname, true)
#define TIMED_BLOCK(obj, blockName) for (struct { int i; easyloggingpp::base::type::PerformanceTrackerPtr timer; } obj = { 0, \
  easyloggingpp::base::type::PerformanceTrackerPtr(new easyloggingpp::base::PerformanceTracker(blockName, ELPP_MIN_UNIT)) }; obj.i < 1; ++obj.i)
...
// Normal logs
#if ELPP_INFO_LOG
#  define CINFO(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Info, dispatchAction, __VA_ARGS__)
#else
#  define CINFO(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_INFO_LOG
#if ELPP_WARNING_LOG
#  define CWARNING(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Warning, dispatchAction, __VA_ARGS__)
#else
#  define CWARNING(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_WARNING_LOG
#if ELPP_DEBUG_LOG
#  define CDEBUG(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Debug, dispatchAction, __VA_ARGS__)
#else
#  define CDEBUG(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_DEBUG_LOG
#if ELPP_ERROR_LOG
#  define CERROR(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Error, dispatchAction, __VA_ARGS__)
#else
#  define CERROR(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_ERROR_LOG
#if ELPP_FATAL_LOG
#  define CFATAL(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Fatal, dispatchAction, __VA_ARGS__)
#else
#  define CFATAL(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_FATAL_LOG
#if ELPP_TRACE_LOG
#  define CTRACE(writer, dispatchAction, ...) ELPP_WRITE_LOG(writer, easyloggingpp::Level::Trace, dispatchAction, __VA_ARGS__)
#else
#  define CTRACE(writer, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_TRACE_LOG
#if ELPP_VERBOSE_LOG
#  define CVERBOSE(writer, vlevel, dispatchAction, ...) if (VLOG_IS_ON(vlevel)) writer(\
easyloggingpp::Level::Verbose, __FILE__, __LINE__, ELPP_FUNC, dispatchAction, vlevel).construct(el_getVALength(__VA_ARGS__), __VA_ARGS__)
#else
#  define CVERBOSE(writer, vlevel, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_VERBOSE_LOG
// Conditional logs
#if ELPP_INFO_LOG
#  define CINFO_IF(writer, condition_, dispatchAction, ...) \
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Info, dispatchAction, __VA_ARGS__)
#else
#  define CINFO_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_INFO_LOG
#if ELPP_WARNING_LOG
#  define CWARNING_IF(writer, condition_, dispatchAction, ...)\
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Warning, dispatchAction, __VA_ARGS__)
#else
#  define CWARNING_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_WARNING_LOG
#if ELPP_DEBUG_LOG
#  define CDEBUG_IF(writer, condition_, dispatchAction, ...)\
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Debug, dispatchAction, __VA_ARGS__)
#else
#  define CDEBUG_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_DEBUG_LOG
#if ELPP_ERROR_LOG
#  define CERROR_IF(writer, condition_, dispatchAction, ...)\
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Error, dispatchAction, __VA_ARGS__)
#else
#  define CERROR_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_ERROR_LOG
#if ELPP_FATAL_LOG
#  define CFATAL_IF(writer, condition_, dispatchAction, ...)\
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Fatal, dispatchAction, __VA_ARGS__)
#else
#  define CFATAL_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_FATAL_LOG
#if ELPP_TRACE_LOG
#  define CTRACE_IF(writer, condition_, dispatchAction, ...)\
ELPP_WRITE_LOG_IF(writer, (condition_), easyloggingpp::Level::Trace, dispatchAction, __VA_ARGS__)
#else
#  define CTRACE_IF(writer, condition_, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_TRACE_LOG
#if ELPP_VERBOSE_LOG
#  define CVERBOSE_IF(writer, condition_, vlevel, dispatchAction, ...) if (VLOG_IS_ON(vlevel) && (condition_)) writer( \
easyloggingpp::Level::Verbose, __FILE__, __LINE__, ELPP_FUNC, dispatchAction, vlevel).construct(el_getVALength(__VA_ARGS__), __VA_ARGS__)
#else
#  define CVERBOSE_IF(writer, condition_, vlevel, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_VERBOSE_LOG
// Occasional logs
#if ELPP_INFO_LOG
#  define CINFO_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Info, dispatchAction, __VA_ARGS__)
#else
#  define CINFO_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_INFO_LOG
#if ELPP_WARNING_LOG
#  define CWARNING_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Warning, dispatchAction, __VA_ARGS__)
#else
#  define CWARNING_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_WARNING_LOG
#if ELPP_DEBUG_LOG
#  define CDEBUG_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Debug, dispatchAction, __VA_ARGS__)
#else
#  define CDEBUG_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_DEBUG_LOG
#if ELPP_ERROR_LOG
#  define CERROR_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Error, dispatchAction, __VA_ARGS__)
#else
#  define CERROR_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_ERROR_LOG
#if ELPP_FATAL_LOG
#  define CFATAL_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Fatal, dispatchAction, __VA_ARGS__)
#else
#  define CFATAL_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_FATAL_LOG
#if ELPP_TRACE_LOG
#  define CTRACE_EVERY_N(writer, occasion, dispatchAction, ...)\
ELPP_WRITE_LOG_EVERY_N(writer, occasion, easyloggingpp::Level::Trace, dispatchAction, __VA_ARGS__)
#else
#  define CTRACE_EVERY_N(writer, occasion, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_TRACE_LOG
#if ELPP_VERBOSE_LOG
...
#else
#  define CVERBOSE_EVERY_N(writer, occasion, vlevel, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_VERBOSE_LOG
// After N logs
#if ELPP_INFO_LOG
#  define CINFO_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Info, dispatchAction, __VA_ARGS__)
#else
#  define CINFO_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_INFO_LOG
#if ELPP_WARNING_LOG
#  define CWARNING_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Warning, dispatchAction, __VA_ARGS__)
#else
#  define CWARNING_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_WARNING_LOG
#if ELPP_DEBUG_LOG
#  define CDEBUG_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Debug, dispatchAction, __VA_ARGS__)
#else
#  define CDEBUG_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_DEBUG_LOG
#if ELPP_ERROR_LOG
#  define CERROR_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Error, dispatchAction, __VA_ARGS__)
#else
#  define CERROR_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_ERROR_LOG
#if ELPP_FATAL_LOG
#  define CFATAL_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Fatal, dispatchAction, __VA_ARGS__)
#else
#  define CFATAL_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_FATAL_LOG
#if ELPP_TRACE_LOG
#  define CTRACE_AFTER_N(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_AFTER_N(writer, n, easyloggingpp::Level::Trace, dispatchAction, __VA_ARGS__)
#else
#  define CTRACE_AFTER_N(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_TRACE_LOG
#if ELPP_VERBOSE_LOG
...
#else
#  define CVERBOSE_AFTER_N(writer, n, vlevel, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_VERBOSE_LOG
// N Times logs
#if ELPP_INFO_LOG
#  define CINFO_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Info, dispatchAction, __VA_ARGS__)
#else
#  define CINFO_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_INFO_LOG
#if ELPP_WARNING_LOG
#  define CWARNING_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Warning, dispatchAction, __VA_ARGS__)
#else
#  define CWARNING_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_WARNING_LOG
#if ELPP_DEBUG_LOG
#  define CDEBUG_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Debug, dispatchAction, __VA_ARGS__)
#else
#  define CDEBUG_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_DEBUG_LOG
#if ELPP_ERROR_LOG
#  define CERROR_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Error, dispatchAction, __VA_ARGS__)
#else
#  define CERROR_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_ERROR_LOG
#if ELPP_FATAL_LOG
#  define CFATAL_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Fatal, dispatchAction, __VA_ARGS__)
#else
#  define CFATAL_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_FATAL_LOG
#if ELPP_TRACE_LOG
#  define CTRACE_N_TIMES(writer, n, dispatchAction, ...)\
ELPP_WRITE_LOG_N_TIMES(writer, n, easyloggingpp::Level::Trace, dispatchAction, __VA_ARGS__)
#else
#  define CTRACE_N_TIMES(writer, n, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_TRACE_LOG
#if ELPP_VERBOSE_LOG
...
#else
#  define CVERBOSE_N_TIMES(writer, n, vlevel, dispatchAction, ...) easyloggingpp::base::NullWriter()
#endif  // ELPP_VERBOSE_LOG
//
...
// Normal logs
#define CLOG(LEVEL, ...)\
C##LEVEL(easyloggingpp::base::Writer, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CVLOG(vlevel, ...) CVERBOSE(easyloggingpp::base::Writer, vlevel, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
// Conditional logs
#define CLOG_IF(condition, LEVEL, ...)\
C##LEVEL##_IF(easyloggingpp::base::Writer, condition, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CVLOG_IF(condition, vlevel, ...)\
CVERBOSE_IF(easyloggingpp::base::Writer, condition, vlevel, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
// Hit counts based logs
#define CLOG_EVERY_N(n, LEVEL, ...)\
C##LEVEL##_EVERY_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CVLOG_EVERY_N(n, vlevel, ...)\
CVERBOSE_EVERY_N(easyloggingpp::base::Writer, n, vlevel, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CLOG_AFTER_N(n, LEVEL, ...)\
C##LEVEL##_AFTER_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CVLOG_AFTER_N(n, vlevel, ...)\
CVERBOSE_AFTER_N(easyloggingpp::base::Writer, n, vlevel, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CLOG_N_TIMES(n, LEVEL, ...)\
C##LEVEL##_N_TIMES(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CVLOG_N_TIMES(n, vlevel, ...)\
CVERBOSE_N_TIMES(easyloggingpp::base::Writer, n, vlevel, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
//
...
#else
#  define ELPP_CURR_FILE_LOGGER_ID easyloggingpp::base::consts::kDefaultLoggerId
#endif
#undef ELPP_TRACE
...
#undef DPLOG_IF
#define CPLOG(LEVEL, ...)\
C##LEVEL(easyloggingpp::base::PErrorWriter, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define CPLOG_IF(condition, LEVEL, ...)\
C##LEVEL##_IF(easyloggingpp::base::PErrorWriter, condition, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define DCPLOG(LEVEL, ...)\
if (ELPP_DEBUG_LOG) C##LEVEL(easyloggingpp::base::PErrorWriter, easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
#define DCPLOG_IF(condition, LEVEL, ...)\
C##LEVEL##_IF(easyloggingpp::base::PErrorWriter, (ELPP_DEBUG_LOG) && (condition), easyloggingpp::base::DispatchAction::NormalLog, __VA_ARGS__)
...
C##LEVEL(easyloggingpp::base::Writer, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define CSYSLOG_IF(condition, LEVEL, ...)\
C##LEVEL##_IF(easyloggingpp::base::Writer, condition, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define CSYSLOG_EVERY_N(n, LEVEL, ...) C##LEVEL##_EVERY_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define CSYSLOG_AFTER_N(n, LEVEL, ...) C##LEVEL##_AFTER_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define CSYSLOG_N_TIMES(n, LEVEL, ...) C##LEVEL##_N_TIMES(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define SYSLOG(LEVEL) CSYSLOG(LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define SYSLOG_IF(condition, LEVEL) CSYSLOG_IF(condition, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define SYSLOG_EVERY_N(n, LEVEL) CSYSLOG_EVERY_N(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define SYSLOG_AFTER_N(n, LEVEL) CSYSLOG_AFTER_N(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define SYSLOG_N_TIMES(n, LEVEL) CSYSLOG_N_TIMES(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define DCSYSLOG(LEVEL, ...) if (ELPP_DEBUG_LOG) C##LEVEL(easyloggingpp::base::Writer, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define DCSYSLOG_IF(condition, LEVEL, ...)\
C##LEVEL##_IF(easyloggingpp::base::Writer, (ELPP_DEBUG_LOG) && (condition), easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define DCSYSLOG_EVERY_N(n, LEVEL, ...)\
if (ELPP_DEBUG_LOG) C##LEVEL##_EVERY_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define DCSYSLOG_AFTER_N(n, LEVEL, ...)\
if (ELPP_DEBUG_LOG) C##LEVEL##_AFTER_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define DCSYSLOG_N_TIMES(n, LEVEL, ...)\
if (ELPP_DEBUG_LOG) C##LEVEL##_EVERY_N(easyloggingpp::base::Writer, n, easyloggingpp::base::DispatchAction::SysLog, __VA_ARGS__)
#  define DSYSLOG(LEVEL) DCSYSLOG(LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define DSYSLOG_IF(condition, LEVEL) DCSYSLOG_IF(condition, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define DSYSLOG_EVERY_N(n, LEVEL) DCSYSLOG_EVERY_N(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define DSYSLOG_AFTER_N(n, LEVEL) DCSYSLOG_AFTER_N(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#  define DSYSLOG_N_TIMES(n, LEVEL) DCSYSLOG_N_TIMES(n, LEVEL, easyloggingpp::base::consts::kSysLogLoggerId)
#else
#  define CSYSLOG(LEVEL, ...) easyloggingpp::base::NullWriter()
#  define CSYSLOG_IF(condition, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define CSYSLOG_EVERY_N(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define CSYSLOG_AFTER_N(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define CSYSLOG_N_TIMES(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define SYSLOG(LEVEL) easyloggingpp::base::NullWriter()
#  define SYSLOG_IF(condition, LEVEL) easyloggingpp::base::NullWriter()
#  define SYSLOG_EVERY_N(n, LEVEL) easyloggingpp::base::NullWriter()
#  define SYSLOG_AFTER_N(n, LEVEL) easyloggingpp::base::NullWriter()
#  define SYSLOG_N_TIMES(n, LEVEL) easyloggingpp::base::NullWriter()
#  define DCSYSLOG(LEVEL, ...) easyloggingpp::base::NullWriter()
#  define DCSYSLOG_IF(condition, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define DCSYSLOG_EVERY_N(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define DCSYSLOG_AFTER_N(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define DCSYSLOG_N_TIMES(n, LEVEL, ...) easyloggingpp::base::NullWriter()
#  define DSYSLOG(LEVEL) easyloggingpp::base::NullWriter()
#  define DSYSLOG_IF(condition, LEVEL) easyloggingpp::base::NullWriter()
#  define DSYSLOG_EVERY_N(n, LEVEL) easyloggingpp::base::NullWriter()
#  define DSYSLOG_AFTER_N(n, LEVEL) easyloggingpp::base::NullWriter()
#  define DSYSLOG_N_TIMES(n, LEVEL) easyloggingpp::base::NullWriter()
#endif  // defined(ELPP_SYSLOG)
//
...
#define CCHECK_STREQ(str1, str2, ...) CLOG_IF(!easyloggingpp::base::utils::Str::cStringEq(str1, str2), FATAL, __VA_ARGS__) \
<< "Check failed: [" << #str1 << " == " << #str2 << "] "
#define CCHECK_STRNE(str1, str2, ...) CLOG_IF(easyloggingpp::base::utils::Str::cStringEq(str1, str2), FATAL, __VA_ARGS__) \
<< "Check failed: [" << #str1 << " != " << #str2 << "] "
#define CCHECK_STRCASEEQ(str1, str2, ...) CLOG_IF(!easyloggingpp::base::utils::Str::cStringCaseEq(str1, str2), FATAL, __VA_ARGS__) \
<< "Check failed: [" << #str1 << " == " << #str2 << "] "
#define CCHECK_STRCASENE(str1, str2, ...) CLOG_IF(easyloggingpp::base::utils::Str::cStringCaseEq(str1, str2), FATAL, __VA_ARGS__) \
<< "Check failed: [" << #str1 << " != " << #str2 << "] "
...
namespace easyloggingpp { \
namespace base { \
easyloggingpp::base::type::StoragePointer elStorage(val); \
} \
easyloggingpp::base::debug::CrashHandler elCrashHandler(ELPP_USE_DEF_CRASH_HANDLER); \
}

#if ELPP_ASYNC_LOGGING
#  define INITIALIZE_EASYLOGGINGPP ELPP_INIT_EASYLOGGINGPP(new easyloggingpp::base::Storage(easyloggingpp::LogBuilderPtr(new easyloggingpp::base::DefaultLogBuilder()),\
new easyloggingpp::base::AsyncDispatchWorker()))
#else
#  define INITIALIZE_EASYLOGGINGPP ELPP_INIT_EASYLOGGINGPP(new easyloggingpp::base::Storage(easyloggingpp::LogBuilderPtr(new easyloggingpp::base::DefaultLogBuilder())))
#endif  // ELPP_ASYNC_LOGGING
...
namespace el {\
namespace base {\
easyloggingpp::base::type::StoragePointer elStorage;\
}\
easyloggingpp::base::debug::CrashHandler elCrashHandler(ELPP_USE_DEF_CRASH_HANDLER);\
}
...
namespace el {\
namespace base {\
easyloggingpp::base::type::StoragePointer elStorage(initializedStorage);\
}\
easyloggingpp::base::debug::CrashHandler elCrashHandler(ELPP_USE_DEF_CRASH_HANDLER);\
}

#if defined(ELPP_UNICODE)
#  define START_EASYLOGGINGPP(argc, argv) easyloggingpp::Helpers::setArgs(argc, argv); std::locale::global(std::locale(""))
#else
#  define START_EASYLOGGINGPP(argc, argv) easyloggingpp::Helpers::setArgs(argc, argv)
#endif  // defined(ELPP_UNICODE)
